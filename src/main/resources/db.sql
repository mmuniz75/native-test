...
INSERT INTO answer (content,subject,url,videonumber) VALUES ('Yes, in the Community Galactica there are about 30 galactic races of humanoids with ...','There is a video showing the autopsy of a very small humanoid just over a foot tall. The proportions of his body was like that of an earthlings.  Was this video fake or do these beings exist?','https://www.youtube.com/watch?v=rsAXYOc2aPM',3);
INSERT INTO answer (content,subject,url,videonumber) VALUES ('Clear and obvious yes. Aryans, Saxon, Roman, Oriental, Indian, Indians, blacks, etc..','Are there beings just like us living on other planets in the universe?','',3);
INSERT INTO answer (content,subject,url,videonumber) VALUES ('We are from Andromeda Galaxy is 2.9 million light years from the Milky Way as you call your galaxy.','We have news of spacecraft that are approaching the Earth to stand on the major cities in next month, coming from the Pleiades, is this true?','',5);
INSERT INTO answer (content,subject,url,videonumber) VALUES ('Well, the meaning of God is harmony, wellness, live in safe places and be totally at ease in life and in death, ...','Do you believe in a creator God of the Universe?','',4);
